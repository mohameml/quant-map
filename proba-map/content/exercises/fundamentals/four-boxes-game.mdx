...
<Hint n={1}>
The 100 euros is equally likely to be in any of the 4 boxes. Compute the probability that the player finds it on the 1st, 2nd, 3rd, or 4th try.
</Hint>

<Hint n={2}>
Write the expected payoff as a function of $X$, then set it equal to zero (fair game condition) and solve for $X$.
</Hint>
