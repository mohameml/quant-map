...
<Hint n={1}>
    Model the problem as a Markov chain with three states based on the current
    streak of consecutive Heads: 0, 1, or 2 (absorbing). Write the transition
    probabilities.
</Hint>
