...
<Hint n={2}>
    Once you have the posterior probabilities for each coin, use the law of
    total probability to compute the chance of Heads on the second flip.
    Remember that flips are conditionally independent given the coin.
</Hint>
